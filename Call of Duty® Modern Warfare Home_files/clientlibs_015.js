...
(function($, ATVI) {
    ...
    bundlesObj.psn = [{cmsId: 'basic', itemName: 'battle_pass_upgrade_4'}, {cmsId: 'bundle', itemName: 'battle_pass_upgrade_bundle_ps_4'}];
	bundlesObj.xbl = [{cmsId: 'basic', itemName: 'battle_pass_upgrade_4'}, {cmsId: 'bundle', itemName: 'battle_pass_upgrade_bundle_4'}];
    bundlesObj.battle = [{cmsId: 'basic', itemName: 'battle_pass_upgrade_4'}, {cmsId: 'bundle', itemName: 'battle_pass_upgrade_bundle_4'}];
    ...
    bp.currentSeasonKey = 'loot_season_4';
    bp.currentGameKey = 'cw';
    ...
    var purchaseItem = function(itemName) {
        COD.api.papi.purchaseItem(wtbPortal.user.data.game, wtbPortal.user.data.platform, 'gamer', wtbPortal.user.data.username, itemName, function(d) {
