...
(function($, ATVI) {
    ...
    video.analytics_handlePlay = function(obj) {
        ...
        var player = context.ytPlayer,
            ...
            videoId = (context.opts.isList) ? player.getPlaylist()[player.getPlaylistIndex()] : context.opts.youtubeId;
        ...
        if (duration) {
            var remainingTime = duration - player.getCurrentTime().toFixed(2);
        ...
        if (dataLayer) dataLayer.push({label: videoId, action: 'play', event: 'media', category: 'media', pageURL: window.location.href, gameName: ATVI.dataLayerGameName});
    };
    ...
    video.analytics_handlePause = function(obj) {
        ...
        if (dataLayer) dataLayer.push({label: videoId, action: 'pause', event: 'media', category: 'media', pageURL: window.location.href, gameName: ATVI.dataLayerGameName});
    };
    ...
    video.analytics_handleEnd = function(obj) {
        ...
        dataLayer.push({label: videoId, action: 'complete', event: 'media', category: 'media', pageURL: window.location.href, gameName: ATVI.dataLayerGameName});
    };
